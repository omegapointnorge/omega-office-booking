    ...
    return (
        <svg version="1.1" viewBox="0 0 3725.3 2712" xmlns="http://www.w3.org/2000/svg">
            <g opacity=".249">
                ...
                <g id="small-room">
                    <path d="m3406.1 1169.4 214.29-481.12-592.86-230.61-315.82 715.82" fill={highlightedId === 2 ? 'red' : 'black'}/>
                </g>
                ...
                <g id="sales">
                    <path d="m112.43 963.79 41.366 644.88 561.8-5.3033-19.092-641.7" fill={highlightedId === 3 ? 'red' : 'black'} />
                </g>
