...
const OfficeMap = observer(({showSeatInfo}) => {
    ...
    const zoomToRoom = (roomName) => {
      ...
      switch (roomName) {
        case 'large-room':
          newViewBox = "1900 1600 1100 1050"; 
          break;
        case 'small-room':
    ...
    <div className='relative'>
      <svg version="1.1" width="745" height="500" viewBox={currentViewBox} xmlns="http://www.w3.org/2000/svg">
        ...
        <g className={zoomedIn ? '' : 'hover:scale-125 origin-[55%_90%] duration-100 cursor-pointer'} onClick={() => zoomToRoom("large-room")}>
          <path id="large-room" text="Large room" stroke="black" strokeWidth="3" fill={zoomedIn ? "ivory" : "gray"} d="m2963.3 2158.6-31.186-12.946v-51.276l0.7653-63.265-261.99 0.5102 1.5306-111.73-260.71-0.5102v-101.53h-259.18l2.0408-105.1-262.76 1.5306v-76.531h-165.31l-5.102 194.9 49.49 118.37 1.0204 203.06-52.551 159.18 131.12 27.551 909.69 267.35z"/>
          ...
          <text x="2020" y="2230" className={zoomedIn ? 'hidden' : ""} fill="white" fontSize="155" fontWeight="bolder" fontFamily="Arial">8</text>
        </g>
        <g className={zoomedIn ? '' : 'hover:scale-125 hover:brightness-110 origin-[85%_20%] duration-100 cursor-pointer'} onClick={() => zoomToRoom('small-room')}>
          <path id="small-room" stroke="black" strokeWidth="3" fill={zoomedIn ? "ivory" : "gray"} d="m3406.1 1169.4 214.29-481.12-592.86-230.61-315.82 715.82z"/>
          ...
          <text x="2960" y="1000" className={zoomedIn ? 'hidden' : ""} fill="white" fontSize="155" fontWeight="bolder" fontFamily="Arial">5</text>

        </g>
        <g className={zoomedIn ? '' : 'hover:scale-125 hover:brightness-110 origin-[5%_45%] duration-100 cursor-pointer'} opacity="1.0">
        ...
        <g className={zoomedIn ? '' : "hidden"} stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5">
