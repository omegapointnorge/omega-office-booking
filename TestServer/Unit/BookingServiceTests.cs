...
public class BookingServiceTests : TestServiceBase<BookingService>
{
    ...
    [Fact]
    public async Task CreateBookingAsync_BookingAfter15_ReturnsBookingDto()
    {
        // Arrange
        var bookingDateTime = DateTime.Today.AddDays(1).AddHours(16); // Next day after 15:00
    ...
    [Fact]
    public async Task CreateBookingAsync_BookingBefore15_ReturnsError()
    {
        // Arrange
    ...
    public async Task CreateBookingAsync_AttemptToBookBefore15_ThrowsException()
    {
        // Arrange
        var bookingDateTime = DateTime.Today.AddDays(1).AddHours(14); // Next day after 14:00
        var bookingRequest = new CreateBookingRequest { BookingDateTime = bookingDateTime, SeatId = 2 }; // Changed the bookingDateTime
        var userClaims = GetUserClaims();
